...
namespace Tests.Services
{
    public class UserServiceTests
    {
        ...
        [Fact]
        public async Task UpdateAsync_QuandoExisteUsuario_Chama_UserRepository_Upadate_E_SaveChengesAsync_Retorna_True() 
        {
            //Preparação (Arrange)
        ...
        [Fact]
        public async Task UpdateToAdmin_QuandoExisteUsuario_Chama_UserRepository_Update_E_SaveChanges() 
        {
            // Preparação (Arrange)
            var userId = 1;
            var existingUser = new User { Id = userId };
        ...
        [Fact]
        public async Task UpdateToAdmin_QuandoNaoExisteUsuario_NãoChama_UserRepository_Update_E_SavaChangesAsync() 
        {
            //Preparação (Arrange)
            var userId = 1;
